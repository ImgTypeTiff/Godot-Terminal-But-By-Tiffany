const APPLICATIONS := {
	...
	"help": preload("res://addons/GodotTerminalButByTiffany/assets/applications/help.gd"),
	"quit": preload("res://addons/GodotTerminalButByTiffany/assets/applications/quit.gd"),
